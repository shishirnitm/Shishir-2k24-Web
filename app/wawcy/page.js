...
export default function home() {                                        
  return (
    <div className="flex flex-col   ">
      ...
      <div className="text-[#E03932] font-bernier text-[37px] mt-[22px] md:-[35px] md:text-[47px] lg:text-[70px] flex justify-center items-center sm:text-[50px] ">
      ...
      <div className="mt-[15px] sm:mt-[60px] md:mt-[80px] lg:mt-[120px] xl:mt-[160px] pl-[30px] pr-[30px] pt-[50px] font-blogger text-[#186B80] text-[20px] leading-[23px] md:leading-[25px] md:text-[25px]">
        <div>
          Yo, listen up, Visitors! <spam className="font-bloggerBold"> NITM&apos;s Shishir</spam>  is run by a bunch of
          hardworking students who bust their butts to bring you this epic
          experience.
        </div>
        <br></br>
        <div>
        ...
        <br></br>
        <div>
          So, here&apos;s the deal  you gotta cough up a <spam className="font-bloggerBold">few bucks </spam> to join in on the
          fun. But trust us, it&apos;s worth every rupee for the wild time you&apos;re
          about to have!
        </div>
        <br></br>
